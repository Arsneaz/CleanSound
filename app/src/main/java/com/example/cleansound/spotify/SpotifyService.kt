...
import com.example.cleansound.model.response.playlists.FeaturedPlaylists
import com.example.cleansound.model.response.search.SearchTrack
...
interface SpotifyService {
    @GET("browse/featured-playlists?country=ID&limit=8")
